    ...
    return (
        <div className='flex max-w-2xl mx-auto pl-10'>
            <section className='flex flex-col gap-6 w-full my-8'>
                ...
                <div>
                    <h1 className='font-bold text-xl mb-2'>Club Name</h1>
                    <Textarea value={input.club} onChange={(e) => setInput({ ...input, club: e.target.value })} name='club' className="focus-visible:ring-transparent" />
                </div>
